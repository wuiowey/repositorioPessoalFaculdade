...
namespace site
{
    public partial class Registro : System.Web.UI.Page
    {
        ...
        protected void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(btnNome.Text))
            {
                Label2.Visible = true;
                return;
            }
            if (string.IsNullOrWhiteSpace(btnSenha.Text))
            {
                Label2.Visible = true;
                return;
            }
            if (string.IsNullOrWhiteSpace(btnSenha1.Text))
            {
                Label2.Visible = true;
                return;
            }
            if (string.IsNullOrWhiteSpace(btnId.Text))
            {
                Label2.Visible = true;
                return;
